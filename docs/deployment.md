...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `scuola-guida.demo.federicocalo.dev`
...
- Output directory: `dist/scuola-guida/browser`
...
URL: `https://fedcal.github.io/federico-demo-scuola-guida/`
...
- `base: /federico-demo-scuola-guida/` (subdirectory GH Pages)
- `cleanUrls: true`
...
1. Cloudflare DNS aggiungi CNAME:
   ```
   scuola-guida-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `scuola-guida-docs.federicocalo.dev`
