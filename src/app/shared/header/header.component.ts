  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home Autoscuola Sicura">
          <span class="brand__icon" aria-hidden="true">🚗</span>
          <span class="brand__text">Autoscuola Sicura</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/quiz-online" routerLinkActive="is-active">Quiz online</a>
